...
set_property PACKAGE_PIN P2 [get_ports {TXP_OUT[7]}]
set_property PACKAGE_PIN P1 [get_ports {TXN_OUT[7]}]
set_property PACKAGE_PIN R4 [get_ports {RXP_IN[7]}]
set_property PACKAGE_PIN R3 [get_ports {RXN_IN[7]}]
set_property PACKAGE_PIN T2 [get_ports {TXP_OUT[6]}]
set_property PACKAGE_PIN T1 [get_ports {TXN_OUT[6]}]
set_property PACKAGE_PIN U4 [get_ports {RXP_IN[6]}]
set_property PACKAGE_PIN U3 [get_ports {RXN_IN[6]}]
set_property PACKAGE_PIN V2 [get_ports {TXP_OUT[5]}]
set_property PACKAGE_PIN V1 [get_ports {TXN_OUT[5]}]
set_property PACKAGE_PIN W4 [get_ports {RXP_IN[5]}]
set_property PACKAGE_PIN W3 [get_ports {RXN_IN[5]}]
set_property PACKAGE_PIN M2 [get_ports {TXP_OUT[4]}]
set_property PACKAGE_PIN M1 [get_ports {TXN_OUT[4]}]
set_property PACKAGE_PIN N4 [get_ports {RXP_IN[4]}]
set_property PACKAGE_PIN N3 [get_ports {RXN_IN[4]}]
set_property PACKAGE_PIN L4 [get_ports {RXP_IN[3]}]
set_property PACKAGE_PIN L3 [get_ports {RXN_IN[3]}]
set_property PACKAGE_PIN K2 [get_ports {TXP_OUT[3]}]
...
set_property PACKAGE_PIN K6 [get_ports {RXP_IN[1]}]
set_property PACKAGE_PIN K5 [get_ports {RXN_IN[1]}]
set_property PACKAGE_PIN H2 [get_ports {TXP_OUT[1]}]
set_property PACKAGE_PIN H1 [get_ports {TXN_OUT[1]}]
set_property PACKAGE_PIN Y2 [get_ports {TXP_OUT[0]}]
set_property PACKAGE_PIN Y1 [get_ports {TXN_OUT[0]}]
set_property PACKAGE_PIN AA4 [get_ports {RXP_IN[0]}]
...
set_property PACKAGE_PIN T6 [get_ports TILE0_REFCLK_PAD_P_IN]
set_property PACKAGE_PIN T5 [get_ports TILE0_REFCLK_PAD_N_IN]
set_property PACKAGE_PIN V6 [get_ports TILE1_REFCLK_PAD_P_IN]
set_property PACKAGE_PIN V5 [get_ports TILE1_REFCLK_PAD_N_IN]
set_property PACKAGE_PIN P6 [get_ports TILE2_REFCLK_PAD_P_IN]
set_property PACKAGE_PIN P5 [get_ports TILE2_REFCLK_PAD_N_IN]
set_property PACKAGE_PIN M6 [get_ports TILE3_REFCLK_PAD_P_IN]
